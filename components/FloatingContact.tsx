...
export default function FloatingContact() {
  ...
  // 👉 Ẩn nút CSKH khi đang ở trang Admin để sếp quản lý cho thoáng màn hình
  if (pathname.startsWith('/admin')) return null;

  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      
      {/* 1. NÚT ĐIỆN THOẠI & BONG BÓNG HIỂN THỊ SỐ */}
      <div className="relative flex items-center justify-end">
        {/* Bong bóng hiện số điện thoại (Chỉ hiện khi showPhone = true) */}
        {showPhone && (
      ...
      {/* 2. NÚT ZALO */}
      <Link
        href="https://zalo.me/0836958396" // Thay số điện thoại Zalo của em vào đây
        target="_blank"
      ...
      {/* 3. NÚT FACEBOOK */}
      <Link
        href="https://www.facebook.com/son.hoangtuan.1042" // Thay link Fanpage/Facebook của em vào đây
        target="_blank"
